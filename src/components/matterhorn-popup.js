const MatterhornPopup = ({ onClose }) => {
  return (
    <div className="relative rounded-lg bg-white w-[900px] flex flex-col p-5 box-border items-start justify-start max-w-full max-h-full overflow-auto sm:p-2.5 sm:box-border">
      <iframe
