          ...
          <div className="self-stretch relative [background:linear-gradient(100.3deg,_#0b5ba8,_#299bd8)] h-[193px] lg:py-[21px] lg:pr-10 lg:pl-[41px] lg:box-border md:py-[21px] md:px-6 md:box-border">
            ...
            <div className="absolute top-[50px] left-[0px] w-[1440px] flex flex-col py-0 px-20 box-border items-start justify-start gap-[8px] lg:pl-10 lg:pr-10 lg:box-border md:pl-6 md:pr-6 md:box-border">
              ...
              <div className="flex flex-row items-start justify-start gap-[8px] text-center text-base font-roboto">
                <div className="rounded-8xl bg-white flex flex-row py-[11px] px-[21px] items-center justify-center text-cornflowerblue-200 border-[1px] border-solid border-white">
                  <div className="relative tracking-[0.04em] capitalize font-medium sm:text-sm">
                    Recommended
                  </div>
                </div>
                <div className="rounded-8xl flex flex-row py-[11px] px-[21px] items-center justify-center border-[1px] border-solid border-white">
                  <div className="relative tracking-[0.04em] capitalize font-medium sm:text-sm">
                    Price
                  </div>
                </div>
